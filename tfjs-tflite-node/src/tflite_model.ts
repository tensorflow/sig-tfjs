...
import type {ProfileItem, TFLiteDataType, TFLiteWebModelRunner, TFLiteWebModelRunnerTensorInfo} from '@tensorflow/tfjs-tflite/dist/types/tflite_web_model_runner';

export const TFHUB_SEARCH_PARAM = '?lite-format=tflite';
